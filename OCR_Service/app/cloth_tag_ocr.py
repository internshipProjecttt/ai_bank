...
class ClothingLabelOCR:
    ...
    def identifyLabelType(self, image_path):
    ...
    def extractProductInfo(self, image_path, debug=True):
    ...
    def extractFabricInfo(self, image_path, debug=True):
        """Kumaş/içerik etiketinden bilgileri çıkar"""
